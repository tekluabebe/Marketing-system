        ...
        <?php 
			if(isset($_GET['success'])){
				...
				echo "<form method='post' action='adddept.php?success=1'>
					  <table>
					    <tr><td style='padding:5px'>Dept Name: </td><td><input name='dname' type='text' required/></td></tr>
						<tr><td style='padding:5px'>Manager: </td>
						<td><select name='mid'><option value='NULL'>NULL</option>";
				$manager_set = mysqli_query($connect,"SELECT id, first_name, last_name from employee");
