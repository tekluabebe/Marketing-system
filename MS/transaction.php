        ...
        <span id="transalert"></span>
                ...
                <tr><td style="vertical-align:top; padding:10px; width:40%">
                	<table style="margin-left:auto; margin-right:auto">
                        <tr><td>Product ID:</td><td><input type="text" id='prodid' name="prodid" required onChange="pidChange(id,this.value)"/></td></tr>
                        <tr><td>Product Name:</td><td><input type="text" id='prodname'required onchange='pnameChange(name,this.value)' name="prodname"/></td></tr>      				
                        <tr><td>Quantity:</td><td><input type="text" id='quantity'required name="quantity" size="6"/><span id='quantityDisp'></span></td></tr>
                        <tr><td>Price/quantity:</td><td>Rs.&nbsp;<span id="itemPrice">0</span></td></tr>            
